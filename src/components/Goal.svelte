...
<div transition:fade={{duration:1000}} class='goal'>
    ...
    {#if stillWriting}
    <textarea out:fly={{x: -1000, duration:1000}} in:fly={{x: 1000, duration:1000,delay: 1200}} bind:value={goal.text}/>
    <div out:fly={{x: -1000, duration:1000}} in:fly={{x: 1000, duration:1000,delay: 1200}}>
    ...
    {:else}
    <p out:fly={{x: -1000, duration:1000}} in:fly={{x: 1000, duration:1000,delay: 1200}}>{goal.text}</p>
    <div out:fly={{x: -1000, duration:1000}} in:fly={{x: 1000, duration:1000,delay: 1200}}>
